...
if ($tags) {
    ...
    if( $my_query->have_posts() ) {
        echo '<div class="md-padding similar-products"><div class="container"><div class="row"><h3 class="block-head">'.__('Related Projects','superfine').'</h3><div class="portfolioGallery portfolio">';
