...
<div class="container">
	<main id="tp_content" role="main">
		...
		<?php
	        $real_estate_hub_sidebar_layout = get_theme_mod( 'real_estate_hub_sidebar_post_layout','right');
	        if($real_estate_hub_sidebar_layout == 'left'){ ?>
	        <div class="row m-0">
	        ...
	        <div class="clearfix"></div>
	    <?php }else if($real_estate_hub_sidebar_layout == 'right'){ ?>
	        <div class="row m-0">
	          	<div class="col-lg-8 col-md-8">
	    ...
	    <?php }else if($real_estate_hub_sidebar_layout == 'full'){ ?>
	        <div class="full">
	    ...
	    <?php }else if($real_estate_hub_sidebar_layout == 'three-column'){ ?>
	        <div class="row m-0">
	    ...
	    <?php }else if($real_estate_hub_sidebar_layout == 'four-column'){ ?>
	        <div class="row m-0">
	          	<div class="col-lg-3 col-md-3" id="theme-sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
	    ...
	    <?php }else if($real_estate_hub_sidebar_layout == 'grid'){ ?>
	        <div class="row m-0">
