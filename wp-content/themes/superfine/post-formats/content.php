        ...
        <div class="post-info-container">            
            ...
            $posttags = get_the_tags();
             if ($posttags){
                 ...
                 <div class="post-tags no-margin"> <i class="fa fa-tags main-color"></i><?php the_tags(); ?> </div>
            <?php 
            ...
            if ( theme_option('singlesocial_on') == "1" ) {
                ...
                <?php if ( class_exists( 'VCExtendAddonCustomShortCodes' ) ) { ?>
                ...
                <?php
                    ...
                    echo '<div class="share-post shape padding-vertical-20 padding-horizontal-20">Please Install SUPERFINE Shortcodes Plugin to enable Social Sharing.</div>';
                }
                }
            } 
        }
