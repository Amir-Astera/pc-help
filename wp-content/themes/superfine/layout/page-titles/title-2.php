<?php
    ...
    if($cust_title == '1'){
       ...
       $subtitl_text = '<h3 class="sub-title white fx" data-animate="fadeInUp">'.esc_html(get_post_meta(c_page_ID(),'custom_subtitle',true)).'</h3>'; 
    }else{
       $it_page_title = it_custom_page_title(); 
    }
    if($chck_video_bg == '1'){
...
?>
<div class="page-title title-4 <?php echo $vid_class ?> <?php echo $parallax ?>" <?php echo $attr_para; ?>>
        ...
        <div class="row">
            <div class="col-md-12 lft-title">
                <div class="title-container">
                    ...
                    <?php } ?>
                    <h1 class="white bolder uppercase fx" data-animate="fadeInDown"><?php echo $it_page_title; ?></h1>
