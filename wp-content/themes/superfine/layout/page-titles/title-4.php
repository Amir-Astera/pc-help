<?php
    ...
    if($cust_title == '1'){ 
       ...
       $subtitl_text = '<h3 class="sub-title">'.esc_html(get_post_meta(c_page_ID(),'custom_subtitle',true)).'</h3>'; 
    }else{
       $it_page_title = it_custom_page_title(); 
    }
    if($chck_video_bg == '1'){
...
?>
<div class="page-title title-minimal <?php echo $vid_class ?> <?php echo $parallax ?>" <?php echo $attr_para; ?>>
    ...
    <div class="container">
        <div class="row">
            <?php if (theme_option('title_icon') !='' || get_post_meta( c_page_ID() , 'title_icon' , true) != ''){ ?>
                <div class="f-left"><i class="title-icon main-bg shape sm <?php it_page_title_icon(); ?> fx" data-animate="fadeInLeft"></i></div>
            <?php } ?>
            <div class="f-left">
            <h1>
                <?php echo $it_page_title; ?></h1>
