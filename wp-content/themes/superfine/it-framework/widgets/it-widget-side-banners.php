...
class banners_ads_widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct('it_widget_side_banners',__('* Side Banners', 'superfine'), array( 'description' => esc_html__( 'Add Banners on the sidebars.', 'superfine' )));
    }
    
    public function widget( $args, $instance ) {
        
        $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Banners','superfine' ) : $instance['title'], $instance, $this->id_base );
    ...
    public function form( $instance ) {
        ...
        <p>
            ...
            <input class="regular-text txt-banner" id="<?php echo $this->get_field_id( 'image' ); ?>" name="<?php echo $this->get_field_name( 'image' ); ?>" type="text" value="<?php echo esc_attr( $image ); ?>" />
        <input class="upload_image_button btn-banner" type="button" value="Upload Image" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id( 'im_link' ); ?>"><?php _e( 'Banner Link:','superfine' ); ?></label> 
