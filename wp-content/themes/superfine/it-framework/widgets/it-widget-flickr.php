...
class flickr_widget extends WP_Widget {
    ...
    function __construct() {
        parent::__construct('it_widget_flickr',__('* Flickr Feed', 'superfine'), array( 'description' => esc_html__( 'Flickr feed widget.', 'superfine' )));
    }
    
    public function widget( $args, $instance ) {
        $title = apply_filters( 'widget_title', empty( $instance['title'] ) ? esc_html__( 'Flickr feed','superfine' ) : $instance['title'], $instance, $this->id_base );
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = esc_html__( 'Flickr Feed', 'superfine' );
            $flicker_id = '';
            $limit = '';
            $widget_txt = '';
        }
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'widget_txt' ); ?>"><?php _e( 'Content:','superfine' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'flicker_id' )); ?>"><?php _e( 'Flickr ID:','superfine' ); ?></label> 
        ...
        <p>
            <label for="<?php echo esc_attr($this->get_field_id( 'limit' )); ?>"><?php _e( 'Limit:','superfine' ); ?></label> 
