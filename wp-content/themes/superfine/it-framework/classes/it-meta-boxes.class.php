...
class ITMetaBoxes {
    ...
    public function show_meta_boxes() {
        ...
        echo '<span class="hidden page_settings_title">'.__('Custom Page Settings','superfine').'</span>';
    ...
    public function type_file( $field, $meta ) {
        ...
        if ( $data_type == 'video'){
            ...
            <input type='button' class='upload_video_button' value='".__('Upload','superfine'). " " .$field["name"]."' /></div>";
            ...
            <input type='button' class='upload_image_button' value='".__('Browse','superfine')."' />
