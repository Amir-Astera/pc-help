...
class Walker_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        if ( ! empty( $item->_invalid ) ) {
            ...
            $title = sprintf( esc_html__( '%s (Invalid)','superfine' ), $item->title );
        } elseif ( isset( $item->post_status ) && 'draft' == $item->post_status ) {
            $classes[] = 'pending';
            $title = sprintf( esc_html__('%s (Pending)','superfine'), $item->title );
        }
        ...
        <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
            <dl class="menu-item-bar">
                <dt class="menu-item-handle">
                    ...
                    <span class="item-controls">
                        ...
                        <span class="item-order hide-if-js">
                            <a href="<?php
                                echo esc_url( wp_nonce_url( add_query_arg(
                                    ...
                                    'move-menu_item'));
                            ?>" class="item-move-up"><abbr title="<?php esc_attr_e('Move up','superfine'); ?>">&#8593;</abbr></a>
                            |
                            <a href="<?php
                            ...
                            ?>" class="item-move-down"><abbr title="<?php esc_attr_e('Move down','superfine'); ?>">&#8595;</abbr></a>
                        </span>
                        <span class="mega-hint">Mega Menu</span>
                        <a class="item-edit" id="edit-<?php echo $item_id; ?>" title="<?php esc_attr_e('Edit Menu Item','superfine'); ?>" href="<?php
                        ...
                        ?>"><?php _e( 'Edit Menu Item','superfine' ); ?></a>
                    </span>
                </dt>
            </dl>
            ...
            <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <p class="description description-thin">
                    ...
                    <?php _e( 'Navigation Label','superfine' ); ?><br />
                    <input type="text" id="edit-menu-item-title-<?php echo $item_id; ?>" class="widefat edit-menu-item-title" name="menu-item-title[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->title ); ?>" />
                    </label>
                </p>
                <p class="description description-thin">
                    <label for="edit-menu-item-attr-title-<?php echo $item_id; ?>">
                        <?php _e( 'Title Attribute','superfine' ); ?><br />
                ...
                <p class="field-link-target description">
                    <label for="edit-menu-item-target-<?php echo $item_id; ?>">
                        ...
                        <?php _e( 'Open link in a new window/tab','superfine' ); ?>
                    </label>
                </p>
                <p class="field-css-classes description description-thin">
                    <label for="edit-menu-item-classes-<?php echo $item_id; ?>">
                        <?php _e( 'CSS Classes (optional)','superfine' ); ?><br />
                        <input type="text" id="edit-menu-item-classes-<?php echo $item_id; ?>" class="widefat code edit-menu-item-classes" name="menu-item-classes[<?php echo $item_id; ?>]" value="<?php echo esc_attr( implode(' ', $item->classes ) ); ?>" />
                    </label>
                </p>
                <p class="field-xfn description description-thin">
                    <label for="edit-menu-item-xfn-<?php echo $item_id; ?>">
                        <?php _e( 'Link Relationship (XFN)','superfine' ); ?><br />
                        <input type="text" id="edit-menu-item-xfn-<?php echo $item_id; ?>" class="widefat code edit-menu-item-xfn" name="menu-item-xfn[<?php echo $item_id; ?>]" value="<?php echo esc_attr( $item->xfn ); ?>" />
                    </label>
                </p>
                <p class="field-description description description-wide">
                    <label for="edit-menu-item-description-<?php echo $item_id; ?>">
                        <?php _e( 'Description','superfine' ); ?><br />
                        <textarea id="edit-menu-item-description-<?php echo $item_id; ?>" class="widefat edit-menu-item-description" rows="3" cols="20" name="menu-item-description[<?php echo $item_id; ?>]"><?php echo esc_html( $item->description ); // textarea_escaped ?></textarea>
                        <span class="description"><?php _e('The description will be displayed in the menu if the current theme supports it.','superfine'); ?></span>
                    </label>
                </p>
                <p class="field-hint description description-thin">
                    <span class="block"><?php _e( 'Hint','superfine' ); ?> </span>  
                ...
                <p class="field-hint description description-thin">
                    <span class="block"><?php _e( 'Hint Type','superfine' ); ?> </span>  
                ...
                <p class="field-custom description description-wide">
                    ...
                    <input type="hidden" name="menu-icon[<?php echo $item_id; ?>]" id="menu-icon-<?php echo $item_id; ?>" class="icon_cust" value="<?php echo esc_attr( $item->icon ); ?>" />
                        <a class="button icon-remove">Remove Icon</a>
                </p>
                <?php if($depth == 0): ?>
                <p class="field-custom description mega-choose">
                        <span class="block"><?php _e( 'Mega Menu','superfine' ); ?> </span>                        
                ...
                <p id="column<?php echo $item_id; ?>" class="field-custom description column-choose">
                    <span class="block"><?php _e( 'Megamenu column','superfine' ); ?></span>
                ...
                <p class="field-move hide-if-no-js description description-wide">
                    <label>
                        <span><?php _e( 'Move','superfine' ); ?></span>
                        <a href="#" class="menus-move-up"><?php _e( 'Up one','superfine' ); ?></a>
                        <a href="#" class="menus-move-down"><?php _e( 'Down one','superfine' ); ?></a>
                        <a href="#" class="menus-move-left"></a>
                        <a href="#" class="menus-move-right"></a>
                        <a href="#" class="menus-move-top"><?php _e( 'To the top','superfine' ); ?></a>
                    </label>
                </p>
                <div class="menu-item-actions description-wide submitbox">
                    <?php if( 'custom' != $item->type && $original_title !== false ) : ?>
                        <p class="link-to-original">
                            <?php printf( esc_html__('Original: %s','superfine'), '<a href="' . esc_attr( $item->url ) . '">' . esc_html( $original_title ) . '</a>' ); ?>
                        </p>
                    <?php endif; ?>
                    ...
                    )); ?>"><?php _e( 'Remove','superfine' ); ?></a> <span class="meta-sep hide-if-no-js"> | </span> <a class="item-cancel submitcancel hide-if-no-js" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url( add_query_arg( array( 'edit-menu-item' => $item_id, 'cancel' => time() ), admin_url( 'nav-menus.php' ) ) );
                        ?>#menu-item-settings-<?php echo $item_id; ?>"><?php _e('Cancel','superfine'); ?></a>
                </div>
